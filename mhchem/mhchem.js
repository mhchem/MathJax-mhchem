 ...
 */
MathJax.Extension["TeX/mhchem"]={version:"3.0.2"},MathJax.Hub.Register.StartupHook("TeX Jax Ready",
...
function(n,r){if(!n)return n;void 0===r&&(r="ce");var o="0",e={};e.pL=0,n=n.replace(/[\u2212\u2013\u2014\u2010]/g,"-");for(var a,u,i=[];;){a!==n?(u=10,a=n):u--;var s=t.c[r],l=s.e.length;n:for(var m=0;m<l;m++){var h=s.e[m],c=t.g(h.g,n);if(c){var p=h.h[o]||h.h["*"]||null;if(p){for(var k=t.j([],p.k),f=k.length,d=0;d<f;d++){var g,q=k[d],v=void 0;if(q.l&&(v=q.m,q=q.l),"string"==typeof q)if(s.h[q])g=s.h[q](e,c.g,v);else{if(!t.h[q])throw["MhchemBugA","mhchem bug A. Please report. ("+q+")"];g=t.h[q](e,c.g,v)}else"function"==typeof q&&(g=q(e,c.g));i=t.j(i,g)}if(o=p.n||o,!(n.length>0))return i;if(p.s||(n=c.t),!p.u)break n}}}if(u<=0)throw["MhchemBugU","mhchem bug U. Please report."]}},
t.j=
...
function(n){return this["@W"](n,"\\ce{","","","}")},"~Z":/^(?:[+\-]?\s?[IVX]+|\\pm\s*0|\$\\pm\$\s*0)$/,"%d":/^[IVX]+/,"@j":/^[+\-]?[0-9]+\/[0-9]+$/,"~%":
...
function(n,r,t,o,e,a,u,i,s,l){var m=this["@V"](n,r);if(null===m)return null;if(n=n.substr(m.length),m=this["@V"](n,t),null===m)return null;var h=this["@U"](n,m.length,o||e);if(null===h)return null;var c=n.substring(0,o?h.y:h.z);if(a||u){var p=this["@W"](n.substr(h.y),a,u,i,s);if(null===p)return null;var k=[c,p.g];return l&&(k=k.join("")),{g:k,t:p.t}}return{g:c,t:n.substr(h.y)}},
"@V":
...
"~T":
function(n,r,o){var e;n.r?("M"===n.rdt?n.rd=t.go(n.rd,"%r"):"T"===n.rdt?n.rd=[{l:"%s",p1:n.rd}]:n.rd=t.go(n.rd),"M"===n.rqt?n.rq=t.go(n.rq,"%r"):"T"===n.rqt?n.rq=[{l:"%s",p1:n.rq}]:n.rq=t.go(n.rq),e={l:"~b",r:n.r,rd:n.rd,rq:n.rq}):(e=[],n.a||n.b||n.p||n.o||n.q||n.d||o?(n.sb&&e.push({l:"~D"}),n.o||n.q||n.d||n.b||n.p||2===o?n.o||n.q||n.d||!n.b&&!n.p?n.o&&"kv"===n["%I"]&&t.g("~Z",n.d||"")?n["%I"]="~Y":n.o&&"kv"===n["%I"]&&!n.q&&(n["%I"]=void 0):(n.o=n.a,n.d=n.b,n.q=n.p,n.a=n.b=n.p=void 0):(n.o=n.a,n.a=void 0),n.a=t.go(n.a,"a"),n.b=t.go(n.b,"bd"),n.p=t.go(n.p,"pq"),n.o=t.go(n.o,"o"),"~Y"===n["%I"]?n.d=t.go(n.d,"%J"):n.d=t.go(n.d,"bd"),n.q=t.go(n.q,"pq"),e.push({l:"~h",a:n.a,b:n.b,p:n.p,o:n.o,q:n.q,d:n.d,"%I":n["%I"]})):e=null);for(var a in n)"pL"!==a&&"yB"!==a&&delete n[a];return e},"~H":
...
function(n){return"\\mskip3mu "+o.go(n.p1)},"%K":
function(n){return"\\mskip2mu "+o.go(n.p1)+"\\mskip1mu "},"~f":
...
function(n){n.rd=o.go(n.rd),n.rq=o.go(n.rq);var r=o.J[n.r];return n.rd||n.rq?"<=>>"===n.r||"<<=>"===n.r||"<-->"===n.r?(r="\\long"+r,n.rd&&(r="\\overset{"+n.rd+"}{"+r+"}"),n.rq&&(r="\\underset{"+n.rq+"}{"+r+"}"),r=" \\mkern3mu\\mathrel{"+r+"}\\mkern3mu "):(n.rq&&(r+="[{"+n.rq+"}]"),r+="{"+n.rd+"}",r=" \\mkern3mu\\mathrel{\\x"+r+"}\\mkern3mu "):r=" \\mkern3mu\\mathrel{\\long"+r+"}\\mkern3mu ",r},"~Q":
function(n){return o.K[n.A]}},
J:{"->":"rightarrow","→":"rightarrow","⟶":"rightarrow","<-":"leftarrow","<->":"leftrightarrow","<-->":"leftrightarrows","<=>":"rightleftharpoons","⇌":"rightleftharpoons","<=>>":"Rightleftharpoons","<<=>":"Leftrightharpoons"},I:{"-":"{-}",1:"{-}","=":"{=}",2:"{=}","#":"{\\equiv}",3:"{\\equiv}","~":"{\\tripledash}","~-":"{\\begin{CEstack}{}\\tripledash\\\\-\\end{CEstack}}","~=":"{\\raise2mu {\\begin{CEstack}{}\\tripledash\\\\-\\\\-\\end{CEstack}}}","~--":"{\\raise2mu {\\begin{CEstack}{}\\tripledash\\\\-\\\\-\\end{CEstack}}}","-~-":"{\\raise2mu {\\begin{CEstack}{}-\\\\\\tripledash\\\\-\\end{CEstack}}}","...":"{{\\cdot}{\\cdot}{\\cdot}}","....":"{{\\cdot}{\\cdot}{\\cdot}{\\cdot}}","->":"{\\rightarrow}","<-":"{\\leftarrow}","<":"{<}",">":"{>}"},L:{"%m":" ","~D":"~","%Q":"\\mkern3mu ","%W":"\\mkern3mu ","~r":"{,}","~n":"{{0}}\\mkern6mu ","~o":"{{0}}\\mkern3mu ","~p":"{{0}}\\mkern1mu ","~I":"\\text{-}","~~":"\\,{\\cdot}\\,","~y":"\\mkern1mu \\bullet\\mkern1mu ","@n":"{\\times}","%%":"\\prime ","%N":"\\cdot ","%O":"\\mkern1mu{\\cdot}\\mkern1mu ","%P":"\\times ","~i":"{\\sim}","^":"uparrow",v:"downarrow","~z":"\\ldots ","~v":"\\mathrm{{0}}K_{\\mathrm{{1}}}","/":"/","%V":"\\,/\\,"},K:{"+":" \\mkern3mu+\\mkern3mu ","-":" \\mkern3mu-\\mkern3mu ","=":" \\mkern3mu=\\mkern3mu ","<":" \\mkern3mu<\\mkern3mu ",">":" \\mkern3mu>\\mkern3mu ","<<":" \\mkern3mu\\ll\\mkern3mu ",">>":" \\mkern3mu\\gg\\mkern3mu ","\\pm":" \\mkern3mu\\pm\\mkern3mu ","$\\pm$":" \\mkern3mu\\pm\\mkern3mu ","\\approx":" \\mkern3mu\\approx\\mkern3mu ","$\\approx$":" \\mkern3mu\\approx\\mkern3mu ",v:" \\downarrow{} ","(v)":" \\downarrow{} ","^":" \\uparrow{} ","(^)":" \\uparrow{} "},go:
